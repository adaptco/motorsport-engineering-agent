...
def validate_jsonl_artifact(path: str | Path, *, required_fields: list[str] | None = None) -> JSONLValidationResult:
    required_fields = required_fields or [
        'session_id', 'driver_id', 'track_id', 'car_id', 'timestamp_ns', 'tick', 'channels'
    ]
    artifact = Path(path)
