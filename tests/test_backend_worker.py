...
def process_fix_ci_job(job: dict) -> None:
    ...
    try:
        ...
        try:
            ...
            if not tests_ok:
                repo.set_job_phase(job_id, "failed", "validation_failed", {"tests_ok": False}, error_message="Test suite failed")
                return
            
            repo.set_job_phase(job_id, "running", "validated", {"tests_ok": True})
            ...
            repo.set_job_phase(job_id, "running", "pushed")
